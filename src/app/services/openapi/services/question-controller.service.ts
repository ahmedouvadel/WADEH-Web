...
export class QuestionControllerService extends BaseService {
  ...
  static readonly GetQuestionByIdPath = '/api/questions/{id}';
   ...
   */
  getQuestionById$Response(params: GetQuestionById$Params, context?: HttpContext): Observable<StrictHttpResponse<QuestionDto>> {
   ...
   * This method doesn't expect any request body.
   */
  getQuestionById(params: GetQuestionById$Params, context?: HttpContext): Observable<QuestionDto> {
    return this.getQuestionById$Response(params, context).pipe(
      map((r: StrictHttpResponse<QuestionDto>): QuestionDto => r.body)
    );
  }

  /** Path part for operation `updateQuestion()` */
  static readonly UpdateQuestionPath = '/api/questions/{id}';
   ...
   */
  updateQuestion$Response(params: UpdateQuestion$Params, context?: HttpContext): Observable<StrictHttpResponse<QuestionDto>> {
   ...
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  updateQuestion(params: UpdateQuestion$Params, context?: HttpContext): Observable<QuestionDto> {
  ...
  static readonly DeleteQuestionPath = '/api/questions/{id}';
  ...
  static readonly GetAllQuestionsPath = '/api/questions';
   ...
   * This method doesn't expect any request body.
   */
  getAllQuestions$Response(params?: GetAllQuestions$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<QuestionDto>>> {
   ...
   * This method doesn't expect any request body.
   */
  getAllQuestions(params?: GetAllQuestions$Params, context?: HttpContext): Observable<Array<QuestionDto>> {
  ...
  static readonly CreateQuestionPath = '/api/questions';
   ...
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  createQuestion$Response(params: CreateQuestion$Params, context?: HttpContext): Observable<StrictHttpResponse<QuestionDto>> {
   ...
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  createQuestion(params: CreateQuestion$Params, context?: HttpContext): Observable<QuestionDto> {
